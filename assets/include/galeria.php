<div class="container">   
    ...
    <div class="grid-row">     
        <div class="grid-column">
            ...
            <img src="assets/img/galeria/alice.jpg" class="vertical" style="border:0">
        ...
        <div class="grid-column">
            ...
            <img src="assets/img/galeria/montagem_Sd_Ryan.jpg" class="vertical">
        ...
        <div class="grid-column">
            ...
            <img src="assets/img/galeria/boneca_fone.jpg" class="vertical">
        </div>
        <div class="grid-column">
            ...
            <img src="assets/img/galeria/cartaz_infancia.jpg" class="vertical">
...
<div id="lightbox" class="auto-middle"></div>
...
<script type="text/javascript">
    ...
    $('section#galeria img').click(function(){
        $('#lightbox').append($(this).clone()).addClass('fadeIn');
    })
